...
def gpucb_known_learner_init(env: MultiClassEnvironment, bids: np.ndarray, prices: np.ndarray,
                             ...
                             ucb_constant: float):
    return Step4UCBRealClassesLearner(env, bids, prices, kernel, alpha, beta, ucb_constant)
...
def main():
    ...
    learner_init_gpucb_known = lambda env: gpucb_known_learner_init(env, bids, prices, kernel, alpha, beta, ucb_constant)
